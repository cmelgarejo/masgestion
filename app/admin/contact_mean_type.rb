ActiveAdmin.register ContactMeanType do
  permit_params :description #, :active
  actions :all, except: [:show]
  menu parent: I18n.t('Configuration'), priority: 1, label: I18n.t('Contact_Mean_Type')

  index title: I18n.t('Contact_Mean_Type') do
  ...
  form do |f|
    ...
    f.inputs I18n.t('Contact_Mean_Type_Details') do
